...
/***/ (function(module, exports, __webpack_require__) {
	...
	function parser(css, options) {
	  if (typeof css !== 'string') throw new Error('Please, pass a string to parse');else if (!css) return __webpack_require__(33)();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NodeType = __webpack_require__(15);
	var TokenType = __webpack_require__(13);
	var debug = __webpack_require__(24)('gonzales-pe.sass');
	 ...
	 * @param {number} val
	 */
	var logCheck = function logCheck(msg, val) {
	  return val && debug('check match: ' + (typeof msg === 'function' ? msg() : msg));
	};
	...
	function checkArguments(i) {
	  ...
	  var result = tokens[start].right - start + 1;
	...
	function checkArgument(i) {
	  ...
	  logCheck(function () {
	    return 'Argument, type ' + tokens[i].argument_child;
	  }, l);
	  return l;
	}
	 ...
	 */
	function checkDeclaration(i) {
	  var result = checkDeclaration1(i) || checkDeclaration2(i);
	...
	function checkDeclDelim(i) {
	  ...
	  var result = tokens[i].type === TokenType.Newline || tokens[i].type === TokenType.Semicolon ? 1 : 0;
	...
	function checkIdentOrInterpolation2(i) {
	  ...
	  if (i < tokensLength - 1 && tokens[i].type === TokenType.FullStop && (l = checkIdentOrInterpolation(i + 1))) {
	    i += 1 + l;
	    tokens[start].ident_last = i - 1;
	    hasNamespace = true;
	  }
	  ...
	  var result = i - start;
	  logCheck(function () {
	    return hasNamespace ? 'IdentOrInterpolation2' : 'IdentOrInterpolation (pass through from 2)';
	  }, result);
	  return result;
	}
	...
	function checkInclude1(i) {
	  ...
	  if (l = checkIdentOrInterpolation2(i)) i += l;else return 0;
	 ...
	 */
	function checkMixin(i) {
	  var result = checkMixin1(i) || checkMixin2(i);
